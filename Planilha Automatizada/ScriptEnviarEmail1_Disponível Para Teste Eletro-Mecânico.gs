...
function EnviarEmail() {          // Nome da função
  
 var start_line = 1;
 var shipping_columm = 4;
 var status = 4;
 var condition = "VERDADEIRO";          // Condição para o envio do E-mail
 var txt_sent = "FALSO"                  // Condição de comparação e confirmação de envio 
 ...
 var email,subject_matter,subject_matter2,subject_matter3, message;         // Variaveis de E-mails, Assunto e Menssagem do E-mail
  ...
  
  {
   ...
   subject_matter = "Externo - Disponível P/ Teste Elétro-Mecânico";          // Dados do 1° Destino de E-mail
   var message = "E-mail automático, por favor não responder! - Processo Finalizado!"
   */
   
   var email2 = "vinicius@dankia.com.br"
   subject_matter2 = "Externo - Disponível P/ Teste Elétro-Mecânico"          // Dados do 2° Destino de E-mail
   var message2 = "Processo Finalizado!"
   
   /*
   var email3 = "exemplo3@hotmail.com"
   subject_matter3 = "Externo - Disponível P/ Teste Elétro-Mecânico"         // Dados do 3° Destino de E-mail
