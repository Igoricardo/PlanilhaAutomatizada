...
function EnviarEmail2() {          // Nome da função
  
 var start_line = 1;
 var shipping_columm = 3;
 var status = 3;
 var condition = "VERDADEIRO2";          // Condição para o envio do E-mail
 var txt_sent = "FALSO2"                  // Condição de comparação e confirmação de envio 
 ...
 var email,subject_matter,subject_matter2,subject_matter3, message;         // Variaveis de E-mails, Assunto e Menssagem do E-mail
  ...
  
  {
   ...
   subject_matter = "Externo - Retrabalho Finalizado";          // Dados do 1° Destino de E-mail
   var message = "E-mail automático, por favor não responder! - Processo Finalizado!"
   
   /*
   var email2 = "exemplo2@gmail.com"
   subject_matter2 = "Externo - Retrabalho Finalizado"          // Dados do 2° Destino de E-mail
   var message2 = "Processo Finalizado!"
    
   var email3 = "exemplo3@hotmail.com"
   subject_matter3 = "Externo - Retrabalho Finalizado"         // Dados do 3° Destino de E-mail
